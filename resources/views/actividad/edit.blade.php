...
@section('content')
    ...
    <div class="content-card">
        ...
        <div class="header-container">
            <div>
                <h3 class="section-title">Editar Actividad</h3>
        ...
        <div style="background: var(--color-bg-light); padding: 1.5rem; border-radius: var(--border-radius); border: 1px solid var(--color-border); margin-bottom: 2rem;">
            <div style="display: flex; align-items: center; gap: 1rem;">
                ...
                <div>
                    <h5 style="font-family: var(--font-heading); font-weight: 600; color: var(--color-text-dark); margin-bottom: 0.25rem;">Editando actividad:</h5>
                ...
                <div style="display: flex; align-items: flex-start; gap: 1rem;">
                    ...
                    <div>
                        ...
                        <p style="color: #856404; font-size: 0.875rem; margin: 0;">
                            ...
                            Esta actividad tiene <strong>{{ $actividad->participantes_count ?? 0 }}</strong> participantes registrados.
                        </p>
                    </div>
                </div>
            </div>

...
@section('content')
    ...
    <div class="content-card">
        ...
        <h3 class="section-title">Editar Código de Actividad: {{ $codigo->codigo_actividad }}</h3> 
        <p class="section-subtitle">Modifica la información del código seleccionado.</p>
            ...
            <div class="form-grid">
                ...
                <div class="form-group form-span-2">
                    ...
                    <textarea id="descripcion" 
                              ...
                              rows="3">{{ old('descripcion', $codigo->descripcion) }}</textarea>
                    @error('descripcion')
                        <p class="input-error-message">{{ $message }}</p>
                    @enderror
                </div>

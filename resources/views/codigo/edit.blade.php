...
@section('title', 'Editar Código de Actividad: ' . $codigo->codigo_actividad)
...
@section('content')
    ...
    <div class="content-card">
        ...
        <div class="header-container">
            <div>
                <h3 class="section-title">Editar Código de Actividad</h3>
        ...
        <form action="{{ route('codigo.update', $codigo->codigo_actividad) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-grid">
                <div class="form-group">
                    <label for="codigo_actividad" class="form-label">
                        <span style="color: var(--color-danger);">*</span> Código (2 caracteres)
                    </label>
                    <input type="text" 
                           id="codigo_actividad" 
                           name="codigo_actividad" 
                           class="form-input @error('codigo_actividad') is-invalid @enderror"
                           value="{{ old('codigo_actividad', $codigo->codigo_actividad) }}" 
                           required 
                           maxlength="2"
                           minlength="1"
                ...
                <div class="form-group-full">
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('nombre_actividad', $codigo->nombre_actividad) }}" 
                           required 
                           maxlength="100"
                           placeholder="Ej: Terapia Física, Evaluación Psicológica">
                ...
                <div class="form-group-full">
                    ...
                    <textarea id="descripcion" 
                              ...
                              rows="4"
                              placeholder="Descripción detallada de la actividad (opcional)">{{ old('descripcion', $codigo->descripcion) }}</textarea>
                    @error('descripcion')
                        <div class="form-error-message">
                            <svg style="width: 1rem; height: 1rem; margin-right: 0.25rem;" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            {{ $message }}
                ...
                <div style="display: flex; align-items: flex-start; gap: 1rem;">
                    ...
                    <div>
                        ...
                        <p style="color: #856404; font-size: 0.875rem; margin: 0;">
                            Los cambios en el código podrían afectar a registros asociados en el sistema. 
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Automáticamente poner en mayúsculas el código

...
@section('content')
    ...
    <div class="header-container">
        <div>
            <h3 class="section-title">Registrar Nueva Institución</h3>
            <p class="section-subtitle" style="color: var(--color-text-medium); margin-top: 0.5rem;">
                Complete la información para agregar una nueva institución al sistema
            </p>
        </div>
                ...
                <div style="display: flex; align-items: flex-start; gap: 1rem;">
                    ...
                    <div>
                        ...
                        <p style="color: var(--color-text-medium); font-size: 0.875rem; margin: 0;">
                            ...
                            La información será utilizada para identificar y contactar a la institución en el sistema.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            telefonoInput.addEventListener('input', function(e) {
                ...
                if (value.length > 0) {
                    // Formato básico para números bolivianos
                    if (value.length <= 8) {

...
@section('title', 'Añadir Nueva Institución')

@section('content')
    
    <div class="page-header">
        <h1 class="section-title">Añadir Nueva Institución</h1> 
        ...
        <form action="{{ route('institucion.store') }}" method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select id="tipo" name="tipo" 
                            class="form-input @error('tipo') is-invalid @enderror" required>
                        ...
                        <option value="ONG" {{ old('tipo') == 'ONG' ? 'selected' : '' }}>ONG / Fundación</option>
                        <option value="Mixta" {{ old('tipo') == 'Mixta' ? 'selected' : '' }}>Mixta</option>
                    </select>
                    @error('tipo')
                        <p class="input-error-message">{{ $message }}</p>
                    @enderror
                ...
                {{-- CAMPO REQUERIDO: telefono (¡CAMBIO AQUÍ!) --}}
                <div class="form-group">
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary">
                    <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
